...
namespace XXHash
{
    public static partial class XXHash64
    {
			...
			public unsafe static ulong Hash(this Byte[] input, int offset, int count, ulong seed = 0)
			{
			...
			public unsafe static ulong Hash(this Byte[] input, ulong seed = 0)
			{
			...
			public unsafe static ulong Hash(this SByte[] input, int offset, int count, ulong seed = 0)
			{
				if(input == null || input.Length == 0 || count == 0)
					return 0;
			...
			public unsafe static ulong Hash(this SByte[] input, ulong seed = 0)
			{
				if(input == null || input.Length == 0)
					return 0;
			...
			public unsafe static ulong Hash(this UInt16[] input, int offset, int count, ulong seed = 0)
			{
				if(input == null || input.Length == 0 || count == 0)
					return 0;
			...
			public unsafe static ulong Hash(this UInt16[] input, ulong seed = 0)
			{
				if(input == null || input.Length == 0)
					return 0;
			...
			public unsafe static ulong Hash(this Int16[] input, int offset, int count, ulong seed = 0)
			{
				if(input == null || input.Length == 0 || count == 0)
					return 0;
			...
			public unsafe static ulong Hash(this Int16[] input, ulong seed = 0)
			{
				if(input == null || input.Length == 0)
					return 0;
			...
			public unsafe static ulong Hash(this UInt32[] input, int offset, int count, ulong seed = 0)
			{
				if(input == null || input.Length == 0 || count == 0)
					return 0;
			...
			public unsafe static ulong Hash(this UInt32[] input, ulong seed = 0)
			{
				if(input == null || input.Length == 0)
					return 0;
			...
			public unsafe static ulong Hash(this Int32[] input, int offset, int count, ulong seed = 0)
			{
				if(input == null || input.Length == 0 || count == 0)
					return 0;
			...
			public unsafe static ulong Hash(this Int32[] input, ulong seed = 0)
			{
				if(input == null || input.Length == 0)
					return 0;
			...
			public unsafe static ulong Hash(this UInt64[] input, int offset, int count, ulong seed = 0)
			{
				if(input == null || input.Length == 0 || count == 0)
					return 0;
			...
			public unsafe static ulong Hash(this UInt64[] input, ulong seed = 0)
			{
				if(input == null || input.Length == 0)
					return 0;
			...
			public unsafe static ulong Hash(this Int64[] input, int offset, int count, ulong seed = 0)
			{
				if(input == null || input.Length == 0 || count == 0)
					return 0;
			...
			public unsafe static ulong Hash(this Int64[] input, ulong seed = 0)
			{
				if(input == null || input.Length == 0)
					return 0;
			...
			public unsafe static ulong Hash(this Single[] input, int offset, int count, ulong seed = 0)
			{
				if(input == null || input.Length == 0 || count == 0)
					return 0;
			...
			public unsafe static ulong Hash(this Single[] input, ulong seed = 0)
			{
				if(input == null || input.Length == 0)
					return 0;
			...
			public unsafe static ulong Hash(this Double[] input, int offset, int count, ulong seed = 0)
			{
				if(input == null || input.Length == 0 || count == 0)
					return 0;
			...
			public unsafe static ulong Hash(this Double[] input, ulong seed = 0)
			{
				if(input == null || input.Length == 0)
					return 0;
